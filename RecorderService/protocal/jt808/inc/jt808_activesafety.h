...
typedef enum
{
	...
	ActiveSafePhotoRes_352x288 = 1,
	ActiveSafePhotoRes_704x288,
	ActiveSafePhotoRes_352x576,
	ActiveSafePhotoRes_640x480,
	ActiveSafePhotoRes_1280x720,
	ActiveSafePhotoRes_1920x1080,

} JT808ActiveSafePhotoRes_e;
...
typedef struct
{
	...
	DWORD m_alert_enables;            	/* 报警使能设置 */
	DWORD m_event_enables;             	/* 事件使能设置 */
...
} JT808ActivesafetyActivePhoto_t;
...
typedef struct
{
	...
	DWORD lasttime_nobelt;
	DWORD lasttime_dactive;
	DWORD lasttime_driverchg;

	DWORD lasttime_voice_call;
	DWORD lasttime_voice_smok;
	DWORD lasttime_voice_fati;
	DWORD lasttime_voice_dist;
	DWORD lasttime_voice_abnomal;
	DWORD lasttime_voice_nobelt;
	DWORD lasttime_voice_cover;
	DWORD lasttime_voice_glass;
	...
	DWORD lasttime_pcw;
	DWORD lasttime_hmw;
	DWORD lasttime_aactive;

	DWORD lasttime_voice_lcw;
	DWORD lasttime_voice_fcw;
	DWORD lasttime_voice_ldw;
	DWORD lasttime_voice_pcw;
	DWORD lasttime_voice_hmw;

	jt808_setting_info_dsm_t dmsParam;
	jt808_setting_info_adas_t adasParam;

	JT808ActivesafetyActivePhoto_t dmsActivePhoto;
	JT808ActivesafetyActivePhoto_t adasActivePhoto;
